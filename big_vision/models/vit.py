...
def nd_dense_init(scale, mode, distribution):  # XD: from maxtext.initializers
  ...
  def init_fn(key, shape, dtype, in_axis=0, out_axis=1): # lsp
...
def decode_variant(variant):
  ...
  v, patch = variant, {}
  if "/" in variant:  # variant: such as S/16
  ...
  return {
      ...
      "width": {"mu": 32, "Ti": 192, "S": 384, "M": 512, 'M-B': 512, 'M2-B': 576, "B": 768, "L": 1024, "So400m": 1152, "H": 1280, "g": 1408, "g-opt": 1536, "G": 1664, "G-opt": 1536, "e": 1792}[v],
      "depth": {"mu": 1, "Ti": 12, "S": 12, "M": 12, "M-B": 14, "M2-B": 12, "B": 12, "L": 24, "So400m": 27, "H": 32, "g": 40, "g-opt": 40, "G": 48, "G-opt": 48, "e": 56}[v],
      "mlp_dim": {"mu": 128, "Ti": 768, "S": 1536, "M": 2048, "M-B": 2048,   "M2-B": 2304, "B": 3072, "L": 4096, "So400m": 4304, "H": 5120, "g": 6144, "g-opt": 6144, "G": 8192, "G-opt": 8192, "e": 15360}[v],
      "num_heads": {"mu": 2, "Ti": 3, "S": 6, "M": 8,  "M-B": 8,  "M2-B": 9, "B": 12, "L": 16, "So400m": 16, "H": 16, "g": 16, "g-opt": 16, "G": 16, "G-opt": 16, "e": 16}[v],
